...
class nfs (
  ...
  $pkg_list_client      = $::nfs::params::pkg_list_client,
  $pkg_list_server      = $::nfs::params::pkg_list_server,
  ...
  $create_rpcbind_files = $::nfs::params::create_rpcbind_files,
  $service_idmap_exists = $::nfs::params::service_idmap_exists,
